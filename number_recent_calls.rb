...
puts "Expected: 1 -- Actual: #{rc.ping(1)}"
puts "Expected: 2 -- Actual: #{rc.ping(100)}"
puts "Expected: 3 -- Actual: #{rc.ping(3001)}"
puts "Expected: 3 -- Actual: #{rc.ping(3002)}"
puts "Expected: 1 -- Actual: #{rc.ping(6043)}"
