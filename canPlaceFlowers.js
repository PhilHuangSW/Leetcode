...
const flowerbed6 = [0]
const n6 = 1
const flowerbed7 = [1,0,1,0,1]
const n7 = 0
const flowerbed8 = [0,0]
const n8 = 2
...
describe("can place flowers?", function() {
  ...
  it("returns true if you can place n flowers, false otherwise", function() {
    expect(canPlaceFlowers(flowerbed6, n6)).toEqual(true);
  })
  it("returns true if you can place n flowers, false otherwise", function() {
    expect(canPlaceFlowers(flowerbed7, n7)).toEqual(true);
  })
  it("returns true if you can place n flowers, false otherwise", function() {
    expect(canPlaceFlowers(flowerbed8, n8)).toEqual(false);
  })
})